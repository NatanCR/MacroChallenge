            ...
            VStack(alignment: .center) {
                ...
                if tagsArray.isEmpty {
                    ...
                    Button {
                        ...
                        IdeaTagViewerComponent(idea: AudioIdea(title: textTitle, description: textDescription, textComplete: textComplete, creationDate: Date(), modifiedDate: Date(), audioPath: self.audioUrl?.lastPathComponent ?? "", tag: self.tagsArray, grouped: false))
                    }
